...
export class InitializeV2_2Call extends ethereum.Call {
  get inputs(): InitializeV2_2Call__Inputs {
    return new InitializeV2_2Call__Inputs(this);
  }

  get outputs(): InitializeV2_2Call__Outputs {
    return new InitializeV2_2Call__Outputs(this);
  }
}

export class InitializeV2_2Call__Inputs {
  _call: InitializeV2_2Call;

  constructor(call: InitializeV2_2Call) {
    this._call = call;
  }

  get accountsToBlacklist(): Array<Address> {
...
export class InitializeV2_2Call__Outputs {
  _call: InitializeV2_2Call;
